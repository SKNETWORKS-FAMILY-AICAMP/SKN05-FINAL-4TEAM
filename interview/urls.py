...
from . import views
from .views import generate_questions,interview_page, next_question, check_resume, check_questions
...
urlpatterns = [
    ...
    path('api/check-resume/', views.check_resume, name='check-resume'),
    path('api/check-questions/', views.check_questions, name='check-questions'),
]