...
urlpatterns = [
    ...
    path('api/evaluate_answer/', views.evaluate_answer_view, name='evaluate_answer'),
    path('api/process-interview-evaluation/<int:resume_id>/', views.process_interview_evaluation, name='process_interview_evaluation'),
]